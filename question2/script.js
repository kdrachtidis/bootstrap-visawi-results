...
function updateData() {
  ...
  color.domain(["Very dissatisfied", "Dissatisfied", "Somewhat dissatisfied", "Neutral", "Somewhat satisfied", "Satisfied", "Very satisfied"]);
  ...
  d3.csv("data.csv", function (error, data) {
    ...
    data.forEach(function (d) {
      ...
      d["Very dissatisfied"] = +d[1] * 100 / d.N;
      d["Dissatisfied"] = +d[2] * 100 / d.N;
      d["Somewhat dissatisfied"] = +d[3] * 100 / d.N;
      d["Neutral"] = +d[4] * 100 / d.N;
      d["Somewhat satisfied"] = +d[5] * 100 / d.N;
      d["Satisfied"] = +d[6] * 100 / d.N;
      d["Very satisfied"] = +d[7] * 100 / d.N;
      // add possible additional categories here. only add half of them plus the neutral one.
      var x0 = -1 * (d["Neutral"] / 2 + d["Somewhat dissatisfied"] + d["Dissatisfied"] + d["Very dissatisfied"]);
      var idx = 0;

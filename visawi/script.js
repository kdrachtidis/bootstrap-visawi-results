...
function updateData() {
  ...
  color.domain(["Strongly disagree", "Disagree", "Somewhat disagree", "Neither agree nor disagree", "Somewhat agree", "Agree", "Strongly agree"]);

  d3.csv("visawi/data.csv", function (error, data) {
    ...
    data.forEach(function (d) {
      ...
      d["Neither agree nor disagree"] = +d[4] * 100 / d.N;
      d["Somewhat agree"] = +d[5] * 100 / d.N;
      d["Agree"] = +d[6] * 100 / d.N;
      d["Strongly agree"] = +d[7] * 100 / d.N;
      // add possible additional categories here. only add half of them plus the neutral one.
      var x0 = -1 * (d["Neither agree nor disagree"] / 2 + d["Somewhat disagree"] + d["Disagree"] + d["Strongly disagree"]);
      var idx = 0;
